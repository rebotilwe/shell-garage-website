...
export default function About() {
  ...
  // Helper to observe multiple refs
  useEffect(() => {
    const refs = [
      { ref: headerRef, key: 'header' },
      { ref: originRef, key: 'origin' },
      { ref: valuesRef, key: 'values' },
      { ref: promiseRef, key: 'promise' },
      { ref: communityRef, key: 'community' }
    ];
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            if (key) setVisibleSections(prev => ({ ...prev, [key]: true }));
          }
        });
      },
      { threshold: 0.1 }
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <motion.section
        ...
        variants={fadeInUp}
        className="relative bg-gradient-to-br from-[#DA291C] to-[#b71c1c] overflow-hidden"
      >
...
<p className="text-white/90 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
  ...
  we're the precision stop for the modern traveler, engineered for speed and service.
      ...
      <motion.section
        ref={originRef}
        initial="hidden"
        animate={visibleSections.origin ? 'visible' : 'hidden'}
        variants={fadeInUp}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-8 flex gap-6">
              <div>
                <div className="text-3xl font-black text-[#DA291C]">24/7</div>
                <div className="text-gray-500 text-sm">Always Open</div>
              </div>
              <div>
                <div className="text-3xl font-black text-[#DA291C]">6+</div>
                <div className="text-gray-500 text-sm">Core Services</div>
              </div>
              <div>
                <div className="text-3xl font-black text-[#DA291C]">365</div>
      ...
      {/* 24/7 Promise Section */}
      <motion.section
        ref={promiseRef}
        initial="hidden"
        animate={visibleSections.promise ? 'visible' : 'hidden'}
        variants={fadeInUp}
        className="bg-white py-20 md:py-28 text-center"
      >
        <div className="max-w-4xl mx-auto px-6">
          <div className="inline-flex items-center gap-2 bg-[#DA291C]/10 rounded-full px-4 py-2 mb-6">
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-6 leading-tight">
            When The World <span className="relative inline-block">Sleeps
              <svg className="absolute -bottom-2 left-0 w-full" height="4" viewBox="0 0 200 4">
                <path d="M0 2 L200 2" stroke="#DA291C" strokeWidth="4" strokeDasharray="6 6" />
              </svg>
            </span>
            ,<br />
            We Stay <span className="text-[#FFCD00] bg-gray-900 px-2">Open</span>
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className="text-3xl md:text-4xl font-black text-[#DA291C]">{stat.value}</div>
      ...
      <motion.section
        ref={communityRef}
        initial="hidden"
        animate={visibleSections.community ? 'visible' : 'hidden'}
        variants={fadeInUp}
        className="bg-gray-50 py-20 md:py-28"
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-5 grid grid-rows-2 gap-6">
              ...
              <div className="rounded-2xl overflow-hidden shadow-xl h-[200px] md:h-[215px]">
                <SmartImage src={sparImage} alt="Spar Express" className="rounded-2xl" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-[#DA291C] to-[#b71c1c] py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <Link
            to="/contact"
            className="inline-block bg-[#FFCD00] text-gray-900 px-8 py-3 rounded-full font-bold text-lg hover:scale-105 transition-transform"
          >
            Contact Us Today →
          </Link>
        </div>
