...
export default function Footer() {
  return (
    <footer className="bg-[#1a1a1a] font-['Trebuchet_MS',sans-serif]">
      {/* Top stripe */}
      <div className="h-1 bg-gradient-to-r from-[#DA291C] to-[#FFCD00]" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="text-center sm:text-left">
            <div className="flex items-center justify-center sm:justify-start gap-3 mb-4">
              ...
              />
              <div>
                <div className="text-[#DA291C] font-black text-lg uppercase tracking-wide">Shell</div>
                <div className="text-[#FFCD00] font-bold text-xs uppercase tracking-wider -mt-1">Ottawa</div>
              </div>
            </div>
            ...
            <div className="flex justify-center sm:justify-start gap-3">
              {SOCIAL.map(({ icon, href, label, color }) => (
                <a
                  ...
                  rel="noreferrer"
                  aria-label={label}
                  className="w-10 h-10 rounded-full flex items-center justify-center text-white/60 transition-all duration-200 hover:scale-110"
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <p className="text-white/30 text-xs">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-[#FFCD00] hover:text-[#DA291C] transition-colors duration-200 font-medium"
              >
                Afribiz Connect
              </a>
            </p>
